...
export const TimetableExportControls: React.FC<TimetableExportControlsProps> = ({
  ...
  const exportMutation = useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      // Transform the form schema structure to match what the exporter expects
      const exportSchoolConfig: SchoolConfig = {
        id: schoolConfig.schoolConfigId,
        name: "School Timetable", // Default name since it's not in the form schema
      ...
      exportTimetable({
        ...
        view: variables.view,
        data,
        schoolConfig: exportSchoolConfig,
      });
    },
    onError: (error) => {
